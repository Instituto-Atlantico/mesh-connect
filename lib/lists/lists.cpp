...
void display(node* operationsPointer,
                       int sizeNode) {
  // Cabecaalho da Lista
  Serial.print("\nNode: \n");
  ...
  for (positionCounterVector  = 0; positionCounterVector  < sizeNode; positionCounterVector ++)
...
void insertFront(node*& operationsPointer,
  ...
  if (*sizeNode == 0) {
    ...
    int positionCounterVector ;
    for (positionCounterVector  = 0; positionCounterVector  < *sizeNode; positionCounterVector ++) {
      copyList[positionCounterVector  + 1].name = operationsPointer[positionCounterVector ].name;
      copyList[positionCounterVector  + 1].number = operationsPointer[positionCounterVector ].number;
    }
...
void insertBehind(node*& operationsPointer,
  ...
  *positionNode = *sizeNode;
  ...
  // Posiciona o ultimo elemento no tamanhoNovo -1 , pois comecamos positionCounterVector ando do
  // 0
  ...
  int positionCounterVector ;
  for (positionCounterVector  = 0; positionCounterVector  < *sizeNode; positionCounterVector ++) {
    copyList[positionCounterVector ].name = operationsPointer[positionCounterVector ].name;
    copyList[positionCounterVector ].number = operationsPointer[positionCounterVector ].number;
  }
...
void insertNodePosition(node*& operationsPointer,
  ...
  int positionCounterVector ;
  for (positionCounterVector  = 0; positionCounterVector  < position; positionCounterVector ++) {
    copyList[positionCounterVector ].name = operationsPointer[positionCounterVector ].name;
    copyList[positionCounterVector ].number = operationsPointer[positionCounterVector ].number;
  }
  ...
  // positionCounterVector inua posicionando os outros elementos apos a position desejada
  for (positionCounterVector  = position + 1; positionCounterVector  < *sizeNode + 1; positionCounterVector ++) {
    copyList[positionCounterVector ].name = operationsPointer[positionCounterVector  - 1].name;
    copyList[positionCounterVector ].number = operationsPointer[positionCounterVector  - 1].number;
  }
...
void deleteNodeFront(node*& operationsPointer,
                            int* sizeNode) {
  ...
  // elemento desejado
  int positionCounterVector ;
  for (positionCounterVector  = 1; positionCounterVector  < *sizeNode; positionCounterVector ++) {
    copyList[positionCounterVector  - 1].name = operationsPointer[positionCounterVector ].name;
    copyList[positionCounterVector  - 1].number = operationsPointer[positionCounterVector ].number;
  }
...
void deleteNodeBehind(node*& operationsPointer,
  ...
  *positionNode = *sizeNode - 1;
  ...
  // elemento desejado
  int positionCounterVector ;
  for (positionCounterVector  = 0; positionCounterVector  < *sizeNode - 1; positionCounterVector ++) {
    copyList[positionCounterVector ].name = operationsPointer[positionCounterVector ].name;
    copyList[positionCounterVector ].number = operationsPointer[positionCounterVector ].number;
  }
...
void deleteNodePosition(node*& operationsPointer,
                             int* sizeNode,
                             int position) {
  // Cria um vetor com uma position a mais
  node* copyList = new node[*sizeNode - 1];
